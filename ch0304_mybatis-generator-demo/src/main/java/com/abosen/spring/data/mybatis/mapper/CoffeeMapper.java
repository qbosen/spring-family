package com.abosen.spring.data.mybatis.mapper;
...
public interface CoffeeMapper {
     ...
     *
     * @mbg.generated Wed Apr 24 15:42:45 CST 2019
     */
    ...
    @Insert({
        ...
        "values (#{name,jdbcType=VARCHAR}, #{price,jdbcType=BIGINT,typeHandler=com.abosen.spring.data.mybatis.handler.MoneyTypeHandler}, ",
    ...
    @ResultMap("com.abosen.spring.data.mybatis.mapper.CoffeeMapper.BaseResultMap")
    ...
    @Update({
        ...
        "set NAME = #{name,jdbcType=VARCHAR},",
          "PRICE = #{price,jdbcType=BIGINT,typeHandler=com.abosen.spring.data.mybatis.handler.MoneyTypeHandler},",
